...
namespace linalg
{
    ...
    Rational::Rational()
        : numerator_{0}, denominator_{1} {std::cout << "Rational this:" << this << " &x:" << &numerator_ << " &y:" << &denominator_ << std::endl;}
    
    Rational::Rational(Integer num)
        : numerator_{num}, denominator_{1} {std::cout << "Rational this:" << this << " &x:" << &numerator_ << " &y:" << &denominator_ << std::endl;}
    ...
    Rational Rational::conjugate() const
    {
    ...
    // unary operator
    Rational operator-(Rational const& v)
    {
        return Rational(-v.numer(), v.denom());
    }
